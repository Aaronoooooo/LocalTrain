...
public class SQLOrmTest {
	...
	public void testMapQuery(){
		ClientInterface clientUtil = ElasticSearchHelper.getRestClientUtil();
		List<Map> json = clientUtil.sql(Map.class,"{\"query\": \"SELECT * FROM czting_action_log_test\"}");
		System.out.println(json);
	}
	/**
	...
	public void test_sql(){
		ClientInterface clientUtil = ElasticSearchHelper.getRestClientUtil();
		String json = clientUtil.executeHttp("/_sql/translate?format=json",
				"{\"query\": \"SELECT * FROM czting_action_log_test\"}",
				ClientInterface.HTTP_POST
		);
		System.out.println(json);

		clientUtil.executeHttp("/czting_action_log_test/_search",
				"{\"query\": \"SELECT * FROM czting_action_log_test\"}",
				ClientInterface.HTTP_POST);
	}
